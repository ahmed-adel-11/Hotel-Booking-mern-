...
const Rooms = () => {
  ...
  return (
    <div className="flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24 xl:px-32">
          ...
          return (
            ...
            >
              ...
              <div className="md:w-1/2 flex flex-col gap-2">
                ...
                <div className="flex flex-wrap items-center mt-3 nb-6 gap-4">
      ...
      <div className="max-lg:mx-auto bg-white w-80 border border-gray-300 text-gray-600 max-lg:mb-8 min-lg:mt-16">
        <div
